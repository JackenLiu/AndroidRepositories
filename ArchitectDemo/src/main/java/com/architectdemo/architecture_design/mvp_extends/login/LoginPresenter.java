...
import com.architectdemo.architecture_design.mvp_extends.base.BasePresenter;
...
//                        responseResult(new UserBean("网易", "彭老师"));
//                    } else {
//                        responseResult(null);
//                    }
...
//                    }).start();
            ...
            @Override
            public void responseResult(UserBean userBean) {
                // 不管谁完成需求，有结果就告知View层
