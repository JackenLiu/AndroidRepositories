package com.androidprimary.aidl;
...
import com.androidprimary.IMyAidlInterface;
    ...
    public void operate(View v){
        switch (v.getId()){
            case R.id.start:
                ...
                Intent it1 = new Intent(this,AidlService.class);
                startService(it1);
                break;
            case R.id.stop:
                Intent it2 = new Intent(this,AidlService.class);
                stopService(it2);
                break;
            case R.id.bind:
                ...
                Intent it3 = new Intent(this,AidlService.class);
